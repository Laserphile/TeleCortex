...
#if NEEDS_CLK
    FastLED.addLeds<PANEL_TYPE, PANEL_00_DATA_PIN, PANEL_00_CLK_PIN, RGB, DATA_RATE_MHZ(1)>(panels[panel_count], PANEL_00_LEN);
#else
...
#if NEEDS_CLK
    FastLED.addLeds<PANEL_TYPE, PANEL_01_DATA_PIN, PANEL_01_CLK_PIN, RGB, DATA_RATE_MHZ(1)>(panels[panel_count], PANEL_01_LEN);
#else
...
#if NEEDS_CLK
    FastLED.addLeds<PANEL_TYPE, PANEL_02_DATA_PIN, PANEL_02_CLK_PIN, RGB, DATA_RATE_MHZ(1)>(panels[panel_count], PANEL_02_LEN);
#else
...
#if NEEDS_CLK
    FastLED.addLeds<PANEL_TYPE, PANEL_03_DATA_PIN, PANEL_03_CLK_PIN, RGB, DATA_RATE_MHZ(1)>(panels[panel_count], PANEL_03_LEN);
#else
